...
data_AF <- read_excel("C:/Users/rober/Desktop/Universidad/Hult/Spring/Data Science R/Assignments/Air France business case/Air France Case Spreadsheet Supplement.xls", 
                      sheet = "DoubleClick")

# loading our Mapping for keywords
keyword_label <- read_excel("C:/Users/rober/Desktop/Universidad/Hult/Spring/Data Science R/Assignments/Air France business case/Mapping.xlsx", 
                            sheet = "Keyword_label")

#loading the destinations Air France flights to
destinations <- read_excel("C:/Users/rober/Desktop/Universidad/Hult/Spring/Data Science R/Assignments/Air France business case/Mapping.xlsx",
